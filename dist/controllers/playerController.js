...
const createPlayer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const player = yield Player.createPlayer(req.body);
...
const readPlayer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const player = yield Player.readPlayer(parseInt(req.params.id));
...
const updatePlayer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const player = yield Player.updatePlayer(parseInt(req.params.id), req.body);
        res.status(200).json(player);
    }
    catch (err) {
        let errorMessage = "Failed to do something";
...
const deletePlayer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const deletedCount = yield Player.deletePlayer(parseInt(req.params.id));
