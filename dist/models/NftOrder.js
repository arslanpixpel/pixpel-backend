...
const createOrder = (order) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (0, db_1.query)("INSERT INTO orders(player_id, nft_ids, developer_ids) VALUES($1, $2, $3) RETURNING *", [
        playerId,
        nftIds,
        developerIds,
    ]);
...
const updateOrder = (id, updates) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (0, db_1.query)("UPDATE orders SET player_id=$1 , nft_ids=$2 , developer_ids=$3 WHERE id=$4 RETURNING *", [
        playerId,
        nftIds,
        developerIds,
        id,
